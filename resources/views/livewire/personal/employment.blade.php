<div class="row g-3">
    <div class="col-md-2">
        ...
        <input type="date" class="form-control @error('email') is-invalid @enderror" wire:model="email">
        @error('email')
    ...
    <div class="col-md-2">
        ...
        <input type="date" class="form-control @error('telephone') is-invalid @enderror" wire:model="telephone">
        @error('telephone')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
