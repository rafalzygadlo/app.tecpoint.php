...
<div class="row g-3">
    ...
    <div class="col-md-2">
        ...
        <input class="form-control form-control-lg @error('email') is-invalid @enderror" wire:model.defer="number">
        @error('number')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="row g-3">    
    ...
    <div class="col-md-10">
        ...
        <input class="form-control form-control-lg @error('telephone') is-invalid @enderror" wire:model.defer="city">
        @error('city')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
